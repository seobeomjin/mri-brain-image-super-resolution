...
Original file is located at
    https://colab.research.google.com/drive/1Lh2wz4o4z3ZQmDg_-tPa4jqTprxENe1N
"""
...
def patching(lr_data, hr_data, patch_size = 2, cube_size = 64, usage = 1.0, margin =3, is_training=True):
    ...
    mat = scipy.io.loadmat('/content/gdrive/My Drive/Colab Notebooks/MRI BRAIN image SR/mDCSRN_WGANGP_v2/data_prep/idx_mine.mat')
